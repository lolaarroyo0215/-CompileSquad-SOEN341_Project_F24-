...
class Courses(models.Model):
    ...
    teacher = models.ForeignKey(Instructor, on_delete=models.CASCADE, to_field='user_id')
...
class GroupMembers(models.Model):
    ...
    student = models.ForeignKey(Student, on_delete=models.CASCADE, to_field='user_id')
...
class Evaluation(models.Model):
    evaluator = models.ForeignKey(Student, on_delete=models.CASCADE, to_field='user_id', related_name='given_evaluations')
    evaluatee = models.ForeignKey(Student, on_delete=models.CASCADE, to_field='user_id', related_name='received_evaluations')
    group = models.ForeignKey(Groups,on_delete=models.CASCADE)
