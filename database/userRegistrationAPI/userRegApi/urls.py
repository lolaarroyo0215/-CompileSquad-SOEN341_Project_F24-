...
from .views import get_evaluations, create_evaluation, get_groupMembers, create_groupMember, get_groups, create_group, get_courses, create_course, create_student, create_instructor, student_login, instructor_login, create_team, get_teams, get_students
from . import views
...
urlpatterns = [
    ...
    path('get-groups/<int:course_id>/', get_groups),
    path('create-groupMember/', create_groupMember),
    path('get-groupMembers/<int:group_id>/', get_groupMembers),
