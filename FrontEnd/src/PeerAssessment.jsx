...
export default function NewAssessmentPage() {
  ...
  const [workEthicRating, setWorkEthicRating] = useState(0);
  ...
  const handleStarClick = (dimension) => (rating) => {
    const setRating = dimension === 'conceptual' ? setConceptualRating :
                      dimension === 'practical' ? setPracticalRating :
                      setWorkEthicRating;
    setRating(rating);
  };
    ...
    <div className="bg-slate-200 min-h-screen flex flex-col">
      ...
      <main className="flex-grow p-6">
        ...
        <div className="mb-6">
          ...
          <StarRating rating={conceptualRating} setRating={handleStarClick('conceptual')} />
          <textarea 
            className="w-full mt-2 rounded border border-gray-300 p-2"
        ...
        <div className="mb-6">
          ...
          <StarRating rating={practicalRating} setRating={handleStarClick('practical')} />
          <textarea 
            className="w-full mt-2 rounded border border-gray-300 p-2"
        ...
        <div className="mb-6">
          ...
          <StarRating rating={workEthicRating} setRating={handleStarClick('workEthic')} />
          <textarea 
            className="w-full mt-2 rounded border border-gray-300 p-2"
